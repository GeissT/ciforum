<html>
    <head>
        <title>ciForum - <?= $forum->title ?></title>
    ...
    <body>
        ...
        <div id="wrapper">
            <table width="100%" cellspacing="0">
                <tr>
                    <td id='forumPostTitle' width='60%'><center><b>Post Title</b></center></td>
                <td id='postReplyCount' width='10%'><center><b>Replies</b></center></td>
                <td id='forumPostAuthor' width='30%'><center><b>Post Author</b></center></td>
                </tr>